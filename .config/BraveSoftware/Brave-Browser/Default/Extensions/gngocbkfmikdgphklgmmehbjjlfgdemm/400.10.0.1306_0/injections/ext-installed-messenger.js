...
const runtime_message_types_1 = require("../../enums/runtime-message-types");
const runtime_message_1 = require("../runtime-message");
const host_messenger_base_1 = require("./host-messenger-base");
class ExtInstalledMessengerBase extends host_messenger_base_1.HostMessengerBase {
    //ExtensionPresent
    constructor(params) {
        super(params, 'ExtensionInstalled');
        this.addInstalledListener();
    }
    addInstalledListener() {
        window.addEventListener('message', async (evt) => {
            if (evt.source !== window && ['cmpData', 'refData'].includes(evt.data.messageType)) {
                await this.sendDataFromHostToExt(evt.data);
            }
        });
    }
    async sendDataFromHostToExt(data) {
        await this.sendExtensionMessage(new runtime_message_1.RuntimeMessage(runtime_message_types_1.RuntimeMessageTypes.SendDataFromHostToExt, data));
    }
}
exports.ExtInstalledMessengerBase = ExtInstalledMessengerBase;

},{"../../enums/runtime-message-types":3,"../runtime-message":7,"./host-messenger-base":6}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../../enums/clients":1,"./content-injection-base":4}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ExtInstalledMessenger = void 0;
const ext_installed_messenger_base_1 = require("../../../objects/src/lib/models/content-injection/ext-installed-messenger-base");
class ExtInstalledMessenger extends ext_installed_messenger_base_1.ExtInstalledMessengerBase {
    constructor(params) {
        super(params);
    }
}
exports.ExtInstalledMessenger = ExtInstalledMessenger;
(() => {
    const brand = 'SB';
    window['Prdg'] = window['Prdg'] || {};
    window['Prdg'][brand] = window['Prdg'][brand] || {};
    window['Prdg'][brand]['ExtInstalledMessenger'] = ExtInstalledMessenger;
})();

},{"../../../objects/src/lib/models/content-injection/ext-installed-messenger-base":5}]},{},[8]);
