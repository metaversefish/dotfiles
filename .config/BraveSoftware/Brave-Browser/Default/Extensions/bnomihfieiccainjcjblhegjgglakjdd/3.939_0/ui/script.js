    ...
    layers: {
        ...
        extraButtons: {
            ...
            /*metamask: {
                component: 'a',
                variant: 'metamask',
                text: 'Donate with MetaMask',
                attr: {
                    hidden: function () {
                        return new Date().getTime() - new Date('25 March 2022').getTime() < 0;
                    }
                },
                on: {
                    click: function () {
                        window.open('https://www.youtube.com/improvedtube-ethereum', '_blank');
                    }
                }
            },
            gitcoin: {
                ...
                on: {
                    click: function () {
                        window.open('https://gitcoin.co/grants/4303/code4charity-users400000-years9-workdaily-income-2', '_blank');
                    }
                }
            },*/
            frame_by_frame: {
                component: 'a',
                class: 'frame-by-frame',
                attr: {
                    href: 'https://chrome.google.com/webstore/detail/frame-by-frame/cclnaabdfgnehogonpeddbgejclcjneh',
                    target: '_blank',
                    hidden: function () {
                        return satus.storage.get('frame-by-frame--ad') || false;
                    }
                },
                ...
                css: {
                    ...
                    .frame-by-frame__close {
                        ...
                        background: #fff;
                        border-radius: 50%;
                        box-shadow: 0 0 1px 2px rgb(0,0,0,.2);
                        visibility: hidden;
                    }

                    .frame-by-frame__close::before {
                        content: '';
                        width: 16px;
                        height: 2px;
                        background: #666;
                    ...
                    .frame-by-frame:hover .frame-by-frame__close {
                        visibility: visible
                    }
                ...
                box: {
                    component: 'span',
                    class: 'frame-by-frame__box',

                    block: {
                        component: 'span',
                        class: 'frame-by-frame__block'
                    }
                },
                title: {
                    component: 'span',
                    class: 'frame-by-frame__title',
                    text: 'Frame By Frame'
                },
                subtitle: {
                    component: 'span',
                    class: 'frame-by-frame__subtitle',
                    text: 'by ImprovedTube team'
                },
                time: {
                    component: 'span',
                    class: 'frame-by-frame__time'
                },
                close: {
                    component: 'span',
                    class: 'frame-by-frame__close',
                    on: {
                        click: function () {
                            return satus.storage.set('frame-by-frame--ad', true);
