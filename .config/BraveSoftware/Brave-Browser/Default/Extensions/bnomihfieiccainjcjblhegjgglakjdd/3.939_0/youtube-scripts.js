...
window.addEventListener('load', function () {
    ...
    if (window.ethereum && window.ethereum.isMetaMask && !ImprovedTube.storage.metamask) {
        document.dispatchEvent(new CustomEvent('it-metamask-user'));
    }
});

/*if (location.href.indexOf('improvedtube-ethereum') !== -1) {
    document.head.innerHTML = '';
    
    if (ethereum && ethereum.isMetaMask) {
        document.body.innerHTML = '<div><input type="text">ETH<button>Donate</button></div>';
        ...
        setTimeout(function () {
            ...
            document.querySelector('button').onclick = async function () {
                ...
                ethereum.request({
                    ...
                    params: [{
                        from: accounts[0],
                        to: '0xf6E03Ffa6B04c972C45c91D6Bc449Be81E1C527c',
                        value: '0x' + (Number(document.body.querySelector('input').value)).toString(16)
                }]}).then(function (result) {
                    document.querySelector('div').innerHTML = 'Thank you! <3';
        ...
        document.querySelector('div').innerHTML = 'Install MetaMask or try to reload the page.';
    }
}*/
